...
const fillContentForDashboard = () => {
  ...
  coverElement.className = ("absolute text-6xl grid content-center w-full h-[400px] -z-[1] top-0 px-8 py-4 bg-gradient-to-b from-bg-transparent to-black-base")
  ...
  <section>
    ...
    <h2 class="text-2xl ">Guest User</h2>
  </section>
  </section>
  `;
  let innerHTML = "";
...
const searchScreen = () =>{
  ...
  <input type="search" placeholder="Search Songs" id="search-input" class="text-white bg-light-black  w-full h-[70px] outline-none p-2 text-2xl rounded-md z-20">
  <button id="search-submit" type="submit" class="px-3 py-1 rounded-md h-auto bg-black hover:text-green transition-all z-20 text-2xl" >Search</button>
  </section>  
  `;
  const pageContentElement = document.querySelector("#page-content");
